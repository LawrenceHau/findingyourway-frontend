...
function TundraIceCaveEnding(props) {
...
<Card className="bg-dark text-white" style={{ width: '54rem' }}>
    <Card.Img variant="top" src={allEndings[6].photo_url} />
    <Card.Body>
        <Card.Title>{allEndings[6].path}</Card.Title>
        <Card.Text>{allEndings[6].ending}</Card.Text>
        <Card.Text>{allEndings[6].text}</Card.Text>
...
export default TundraIceCaveEnding;