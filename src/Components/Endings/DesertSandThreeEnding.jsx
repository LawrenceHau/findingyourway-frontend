...
function DesertSandThreeEnding(props) {
...
<Card className="bg-dark text-white" style={{ width: '54rem' }}>
    <Card.Img variant="top" src={allEndings[5].photo_url} />
    <Card.Body>
        <Card.Title>{allEndings[5].path}</Card.Title>
        <Card.Text>{allEndings[5].ending}</Card.Text>
        <Card.Text>{allEndings[5].text}</Card.Text>
...
export default DesertSandThreeEnding;