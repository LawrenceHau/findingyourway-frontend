...
function TundraTopOfMountainEnding(props) {
...
<Card className="bg-dark text-white" style={{ width: '54rem' }}>
    <Card.Img variant="top" src={allEndings[8].photo_url} />
    <Card.Body>
        <Card.Title>{allEndings[8].path}</Card.Title>
        <Card.Text>{allEndings[8].ending}</Card.Text>
        <Card.Text>{allEndings[8].text}</Card.Text>
...
export default TundraTopOfMountainEnding;