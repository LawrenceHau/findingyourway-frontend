...
function DesertSandOneEnding(props) {
...
<Card className="bg-dark text-white" style={{ width: '54rem' }}>
    <Card.Img variant="top" src={allEndings[3].photo_url} />
    <Card.Body>
        <Card.Title>{allEndings[3].path}</Card.Title>
        <Card.Text>{allEndings[3].ending}</Card.Text>
        <Card.Text>{allEndings[3].text}</Card.Text>
...
export default DesertSandOneEnding;